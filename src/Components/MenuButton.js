...
const MenuButton = React.forwardRef(
    ({
      ...
      return ( <
          ...
          aria - controls = {
            open ? `toolbar-example-menu-${children}` : undefined
          }
          onClick = {
            onOpen
          }
...
export default function MenuToolbarExample() {
  ...
  return ( <
    List row aria - label = "Example application menu bar"
    role = "menubar"
